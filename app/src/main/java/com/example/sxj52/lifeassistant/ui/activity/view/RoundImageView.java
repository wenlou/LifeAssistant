package com.example.sxj52.lifeassistant.ui.activity.view;
...
public class RoundImageView extends ImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderColor = a.getColor(R.styleable.RoundImageView_border_col, Color.WHITE);
        mBorderWidth = a.getDimension(R.styleable.RoundImageView_border_wid, 0);
